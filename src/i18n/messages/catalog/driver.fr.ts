...
export const driverVehicles = {
  ...
  detail: {
    ...
    modalDescription:
      "Consultez l'immatriculation, les amendes et échangez avec le personnel au sujet de ce véhicule.",
    close: "Fermer",
    ...
    comments: {
      hint: "Échangez avec le personnel au sujet des documents ou de la vérification de ce véhicule. Séparé du chat de votre profil.",
      title: "Chat véhicule",
      empty: "Aucun message pour l'instant. Posez une question au personnel à propos de ce véhicule.",
      formLabel: "Votre message",
      formPlaceholder:
        "Question sur des documents manquants, le statut de vérification ou un problème d'envoi pour cette voiture…",
      formSend: "Envoyer",
      loadingAria: "Chargement des messages véhicule",
      senderYou: "Vous",
      errorEmpty: "Saisissez un message avant d'envoyer.",
    },
  },
  tracking: {
